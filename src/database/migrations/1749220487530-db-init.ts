...
export class DbInit1749220487530 implements MigrationInterface {
    name = 'DbInit1749220487530'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ALTER TABLE "permissions"
            ADD CONSTRAINT "FK_ae8dcf78abc81b7eff867875560" FOREIGN KEY ("resourceId") REFERENCES "resources"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "users"
